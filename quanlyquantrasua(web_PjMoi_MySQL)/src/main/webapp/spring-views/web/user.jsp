											...
											<div class="tab-content pt-2">
												...
												<%-- <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
													...
													<form:form modelAttribute="nv" method="post" action="user.htm"
														...
														<div class="row mb-3">
															<label for="cmnd"
																class="col-md-4 col-lg-3 col-form-label">Lương</label>
															<div class="col-md-8 col-lg-9">
														...
														<div class="row mb-3">
															<label for="cmnd"
																class="col-md-4 col-lg-3 col-form-label">CMND</label>
															<div class="col-md-8 col-lg-9">
																<form:input id="cmnd" cssClass="form-control"
																	path="cmnd" minlength="10" required="true"
																	pattern="^[0-9]{1,15}$" />
															</div>
														</div>
